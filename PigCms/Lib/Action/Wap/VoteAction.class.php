...
class VoteAction extends WapAction{
	...
	public function index(){
        ...
        if($vote_record && $vote_record != NULL){
            ...
            $success = array('err'=>3,'info'=>'您已经投过票了','hasitems'=>join(',',$hasitems),'hasids'=>join(',',$arritem));
        }
        ...
        $vote_user_count  = $t_record->where(array('vid'=>$vote['id'])))->count();
        $vote['count'] =  $vote_user_count;
