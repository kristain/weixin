...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="alist">
	  <tr>
	    ...
	    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td >
				<?php switch($vo['category']): case "1": ?>新闻动态<?php break;?>
					<?php case "2": ?>系统公告<?php break;?>
					<?php case "3": ?>更新动态<?php break;?>
					<?php case "4": ?>使用帮助<?php break; endswitch;?>
				</td>
				...
				<td align='center'>
                    ...
                    | <?php if(($vo["username"]) == "admin"): ?><font color="#cccccc">删除</font><?php else: ?><a href="javascript:void(0)" onclick="if(confirm('确定删除吗')){location.href='<?php echo U('News/del/',array('id'=>$vo['id']));?>'}">删除</a><?php endif; ?>
				</td>
			</tr><?php endforeach; endif; else: echo "" ;endif; ?>
     <tr bgcolor="#FFFFFF"> 
      <td colspan="6"><div class="listpage"><?php echo ($page); ?></div></td>
    </tr>
