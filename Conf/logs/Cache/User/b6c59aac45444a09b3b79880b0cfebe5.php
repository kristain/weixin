...
<TR>
	...
	<td><input type="input" class="px" id="statdate" value="<?php if($set['start'] != ''): echo (date("Y-m-d",$set["start"])); else: echo ($start_date); endif; ?>" onClick="WdatePicker()" name="start" />
		到
		<input type="input" class="px" id="enddate" value="<?php if($set['end'] != ''): echo (date("Y-m-d",$set["end"])); else: echo ($end_date); endif; ?>" name="end"  onClick="WdatePicker()"  />
	</td>
</TR>
<tr>
