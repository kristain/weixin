...
<ul>
<li class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Yml/index',array('token'=>$token));?>">印美丽设备管理</a></li>
</ul>
...
<div class="content">
          <div class="cLineB">
              <h4 class="left">印美丽设备管理</h4>
              <div class="clr"></div>
          </div>
          
          <div class="cLine">
    <div class="alert">
    <p><span class="bold">使用方法：</span>请先更新username和secret。如需启用留声卡功能,请输入开发者信息(AppId和AppSecret)</p>
    </div>
</div>
          ...
          <div class="cLine">
			...
			<select name="print_enable" id="print_enable"><option value="0" <?php if(($yml["print_enable"] == 0)): ?>selected<?php endif; ?>>关闭打印功能</option><option value="1" <?php if(($yml["print_enable"] == 1)): ?>selected<?php endif; ?>>开启打印功能</option></select>&nbsp;<label for="username" class="control-label">username：</label><input type="text" name="username" value="<?php echo ($yml["username"]); ?>" id="username" class="px" style="width:75px;">&nbsp;<label for="secret" class="control-label">secret：</label><input type="text" name="secret" value="<?php echo ($yml["secret"]); ?>" id="secret" class="px" style="width:75px;">&nbsp;<select name="voice_enable" id="voice_enable"><option value="0" <?php if(($yml["voice_enable"] == 0)): ?>selected<?php endif; ?>>关闭留声卡</option><option value="1" <?php if(($yml["voice_enable"] == 1)): ?>selected<?php endif; ?>>开启留声卡</option></select>&nbsp;<label for="wx_appid" class="control-label">AppId：</label><input type="text" name="wx_appid" value="<?php echo ($yml["wx_appid"]); ?>" id="wx_appid" class="px" style="width:75px;">&nbsp;<label for="wx_appsecret" class="control-label">AppSecret：</label><input type="text" name="wx_appsecret" value="<?php echo ($yml["wx_appsecret"]); ?>" id="wx_appsecret" class="px" style="width:75px;">&nbsp;<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btnGreen">保存</button>
			</form>
            </div>
            <div class="clr"></div>
          </div>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td class="norightborder">
						<a href="<?php echo U('User/Yml/config',array('mid'=>$info['mid']));?>">配置</a>　
				   </td>
