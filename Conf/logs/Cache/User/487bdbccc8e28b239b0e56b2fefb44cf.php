...
<h4 class="left">招聘信息管理 (<?php echo ($page); ?> ) </h4>
	...
	<div class="cLine">
		<div class="pageNavigator left" style=" margin-right:30px"> <a href="<?php echo U('Zhaopin/exportForms',array('token'=>$token));?>" title="导出招聘信息" class="btnGrayS vm bigbtn">导出招聘信息</a>
		</div>
		<div class="pageNavigator left">
			<a href="<?php echo U('Zhaopin/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn">
				<img src="<?php echo RES;?>/images/product/add.png" width="16">添加</a>
		</div>
		<div class="clr"></div>
	</div>
	<div class="msgWrap">
				...
				<tbody>
					...
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
							...
							<td class="norightborder">
								<!--<a href="<?php echo U('Zhaopin/infos',array('pid'=>$item['id'],'token'=>$token));?>">应聘者管理</a>-->&nbsp;&nbsp;<a href="<?php echo U('Zhaopin/set',array('id'=>$item['id'],'token'=>$token));?>">修改</a>&nbsp;&nbsp;<a href="<?php echo U('Zhaopin/del',array('aid'=>$item['pid'],'id'=>$item['id'],'token'=>$token));?>">删除</a>
							</td>
