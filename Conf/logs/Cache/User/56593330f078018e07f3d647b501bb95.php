...
<div class="content">
<div class="cLineB">
<h4 class="left">活动报名</h4>
<div class="clr"></div>
</div>
<!--tab start-->
<div class="tab">
<ul>
<li class="current tabli" id="tab0"><a href="<?php echo U('Baoming/index', array('token' => $token));?>">主题活动列表</a></li>
<li class="tabli" id="tab0"><a href="<?php echo U('Baoming/company', array('token' => $token));?>">回复配置</a></li>
</ul>
</div>
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Baoming/add', array('token' => $token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加报名</a></div>
<div class="clr"></div>
</div>
<!--tab end-->
<div class="msgWrap">
...
<td><?php echo ($o["feiyong"]); ?>元</td>

<td class="norightborder">
<a href="<?php echo U('Baoming/infos',array('token'=>$o['token'],'pid'=>$o['id']));?>">报名人员</a>
<a href="<?php echo U('Baoming/edit',array('id'=>$o['id']));?>">修改</a> 
<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Baoming/delete',array('id'=>$o['id']));?>');">删除</a></td>
