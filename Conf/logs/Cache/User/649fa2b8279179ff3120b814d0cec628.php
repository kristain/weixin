...
<div class="pageNavigator left" style=" margin-right:30px"> <a href="<?php echo U('Fangchan/exportForms',array('token'=>$token));?>" title="导出招聘信息" class="btnGrayS vm bigbtn">导出房源信息</a></div>

<div class="pageNavigator left"> <a href="<?php echo U('Fangchan/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16">添加</a></div>
