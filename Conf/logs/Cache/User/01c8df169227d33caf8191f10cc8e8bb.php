...
<div class="content">
	<div class="cLineB">
<h4 class="left">分享达人</h4>
    <div class="clr"></div>
    </div>
    <!--tab start-->
<div class="tab">
<ul>
<li class="current  tabli" id="tab0"><a href="<?php echo U('Sharetalent/index',array('token'=>$token));?>">分享管理</a></li>
<li class="<?php if($tabid == 2): ?>current<?php endif; ?> tabli" id="tab1"><a href="<?php echo U('Sharetalent/sm',array('token'=>$token));?>">分享说明</a></li>
<li class="<?php if($tabid == 3): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Sharetalent/user',array('token'=>$token));?>">用户管理</a></li>
<li class="<?php if($tabid == 4): ?>current<?php endif; ?> tabli" id="tab3"><a href="<?php echo U('Sharetalent/reply',array('token'=>$token));?>">分享配置</a></li> 
</ul>
</div>
<!--tab end-->
          <div class="cLine">
            <div class="pageNavigator left">
            <a href="<?php echo U('Sharetalent/add');?>" title="添加分享活动" class="btnGrayS vm bigbtn"><img src="./tpl/User/default/common/images/product/add.png" class="vm">添加分享活动</a>
            </div>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                <tr></tr>
                  ...
                  <td class="norightborder"><a class="btnGreen" href="<?php echo U('Sharetalent/edit',array('id'=>$list['id']));?>" title="编辑">编辑</a> <a class="btnGreen" href="javascript:drop_confirm('您确定要删除吗？', '<?php echo U('Sharetalent/del',array('id'=>$list['id']));?>');">删除</a> 
                   
				   <a  class="btnGreen" href="<?php echo U('Sharetalent/prize',array('id'=>$list['id']));?>">奖品发放</a> 
                   </td>
