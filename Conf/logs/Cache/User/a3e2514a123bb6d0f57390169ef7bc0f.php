...
<div class="content"  >
  <div class="cLineB">
    <h4>新增场景</h4>
    <a href="<?php echo U('Scenes/add',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a> </div>
    <div class="tab">

<ul>

<li class="current tabli" id="tab2"><a href="<?php echo U('Scenes/add');?>">新增场景</a></li>



<li class=" tabli" id="tab20"><a href="<?php echo U('Scenes/index');?>">场景管理</a></li>
  ...
  <form class="form" method="post" id="form" action="" enctype="multipart/form-data">
    ...
    <div class="msgWrap bgfc">
      <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
         <tr>
            <th ><span class="red">*</span>触发关键字</th>
            <td><input type="text" name="keyword" id="keyword" value="<?php echo ($set["keyword"]); ?>" class="px" style="width:550px"></td>
          </tr>
          <tr>
            <th ><span class="red">*</span>回复文字</th>
            <td><input type="text" name="title" id="title" value="<?php echo ($set["title"]); ?>" class="px" style="width:550px"></td>
          </tr>
          <tr>
            <th ><span class="red">*</span>回复图片：</th>
            <td><input type="text" id="picurl" value="<?php echo ($set["picurl"]); ?>" name="picurl" class="px" style="width:550px;">
              <script src="/tpl/static/upyun.js"></script> 
              <a href="javascript:void(0)" onclick="upyunPicUpload('picurl',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')" >预览</a></td>
          </tr>
          <tr>
            <th width="120"><span class="red">*</span>回复简介：</th>
            <td><textarea style="width:560px;height:75px" name="info" id="info" class="px" onkeydown='countChar("info","counter");' onkeyup="countChar('info','counter');"><?php echo ($set["info"]); ?></textarea>
              <br/>
          ...
          <tr>
            ...
            <td><input type="text" name="name" id="name" value="<?php echo ($set["name"]); ?>" class="px" style="width:550px"></td>
          </tr>
         <tr>
            <th ><span class="red">*</span>擦一擦文字提示</th>
            <td><input type="text" name="ca" id="ca" placeholder="用手指擦一擦！" value="<?php echo ($set["ca"]); ?>" class="px" style="width:550px"></td>
          </tr>
         <tr>
            <th ><span class="red">*</span>用来涂擦的封面图片：</th>
            <td><input type="text" id="catp" value="<?php echo ($set["catp"]); ?>" name="catp" class="px" style="width:550px;">
              <script src="/tpl/static/upyun.js"></script> 
              <a href="javascript:void(0)" onclick="upyunPicUpload('catp',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('catp')" >预览</a>
             </td>
          </tr>
           <tr><th></th><td><span><img src="tpl/User/default/common/images/Scenes/00.jpg"  style="width:200px"></span><br><br>注意横宽比例:推荐(宽：640px;高：960px)</td></tr>
         <tr>
            <th ><span class="red">*</span>涂擦后显示出来的图片：</th>
            <td><input type="text" id="tph" value="<?php echo ($set["tph"]); ?>" name="tph" class="px" style="width:550px;">
              <script src="/tpl/static/upyun.js"></script> 
              <a href="javascript:void(0)" onclick="upyunPicUpload('tph',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('tph')" >预览</a></td>
          </tr>
            <tr><th></th><td><span><img src="tpl/User/default/common/images/Scenes/01.jpg"  style="width:200px"></span><br><br>注意横宽比例:推荐(宽：640px;高：960px)</td></tr>
         <tr>
					...
					<table><tr><?php if($set["musicurl"] != ''): ?><td><a style="width:120px;float:left" id="musicurl_src" class="audio {skin:'blue'}" href="<?php echo ($set["musicurl"]); ?>">音乐播放</a></td><?php endif; ?><td> <input class="px" name="musicurl" value="<?php echo ($set["musicurl"]); ?>" id="musicurl" style="width:200px;float:left" onchange="$('#musicurl_src').attr('href',this.value"> <a href="###" onclick="upyunPicUpload('musicurl',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a>&nbsp;<a href="###" onclick="chooseFile('musicurl','music')" class="btn btn-primary btn_submit  J_ajax_submit_btn">选择</a></td></tr></table>

					 </td>

				</tr>
                  <tr>
            <th ><span class="red">*</span>场景分享图片：</th>
            <td><input type="text" id="share" value="<?php echo ($set["share"]); ?>" name="share" class="px" style="width:550px;">
           
              <script src="/tpl/static/upyun.js"></script> 
              <a href="javascript:void(0)" onclick="upyunPicUpload('share',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('share')" >预览</a></td>
          </tr>
           <tr><th></th><td><span><img src="tpl/User/default/common/images/Scenes/11.jpg"  style="width:200px"></span><br><br>注意横宽比例:推荐(宽：640px;高：960px)</td></tr>
            <tr>
            <th ><span class="red">*</span>分享按钮图片：</th>
            <td><input type="text" id="sharean" value="<?php echo ($set["sharean"]); ?>" name="sharean" class="px" style="width:550px;">
              <script src="/tpl/static/upyun.js"></script> 
              <a href="javascript:void(0)" onclick="upyunPicUpload('sharean',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('sharean')" >预览</a>
             </td>
          </tr>
           <tr><th></th><td><span><img src="tpl/User/default/common/images/Scenes/fx.jpg"  style="width:200px"></span></td></tr>
           <tr>
            <th ><span class="red">*</span>分享提示图片：</th>
            <td><input type="text" id="sharetstp" value="<?php echo ($set["sharetstp"]); ?>" name="sharetstp" class="px" style="width:550px;">
              <script src="/tpl/static/upyun.js"></script> 
              <a href="javascript:void(0)" onclick="upyunPicUpload('sharetstp',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('sharetstp')" >预览</a>
             
</td>
          </tr>
          <tr><th></th><td><span><img src="tpl/User/default/common/images/Scenes/weixin-share-guide.png"  style="width:200px"></span><br><br>实际效果为背景透明，文字为白色效果最佳</td></tr>
          <tr>
            <th ><span class="red">*</span>分享标题</th>
            <td><input type="text" name="sharetitle" id="sharetitle" value="<?php echo ($set["sharetitle"]); ?>"  placeholder="快来感受下我们的炫丽吧！" class="px" style="width:550px"></td>
          </tr>
          <tr>
            <th ><span class="red">*</span>分享图片：</th>
            <td><input type="text" id="sharetp" value="<?php echo ($set["sharetp"]); ?>" name="sharetp" class="px" style="width:550px;">
              <script src="/tpl/static/upyun.js"></script> 
              <a href="javascript:void(0)" onclick="upyunPicUpload('sharetp',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('sharetp')" >预览</a>
             
</td>
          </tr>
          <tr><th></th><td><span><img src="tpl/User/default/common/images/Scenes/share.jpg"  style="width:200px"></span></td></tr>
           <tr>
            <th width="120"><span class="red">*</span>分享描述：</th>
            <td><textarea style="width:560px;height:75px" placeholder="微场景应用，炫丽起航，带给你不一样的体验！" name="miaosu" id="miaosu" class="px" onkeydown='countChar("miaosu","counter");' onkeyup="countChar('miaosu','counter');"><?php echo ($set["miaosu"]); ?></textarea>
              <br/>
              <font color="red">可以输入<span id="counter">400</span>字<br>
              </font></td>
          </tr>
        ...
        <tr>
          ...
          <th>&nbsp;</th>
          <td><!--input type="hidden" name="time" value="<?php echo ($set["time"]); ?>" /-->
