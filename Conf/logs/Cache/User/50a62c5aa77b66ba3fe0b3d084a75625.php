...
<h4 class="left">简历信息管理 (<?php echo ($page); ?> ) </h4></div>
...
<td style="color:#F00"><?php echo ($item["date"]); ?></td>
...
<td class="norightborder"><!--<a href="<?php echo U('Zhaopin/infos',array('pid'=>$item['id'],'token'=>$token));?>">应聘者管理</a>-->&nbsp;&nbsp;<a href="<?php echo U('Zhaopin/jlset',array('id'=>$item['id'],'token'=>$token));?>">修改</a>&nbsp;&nbsp;<a href="<?php echo U('Zhaopin/jldel',array('aid'=>$item['pid'],'id'=>$item['id'],'token'=>$token));?>">删除</a></td>
