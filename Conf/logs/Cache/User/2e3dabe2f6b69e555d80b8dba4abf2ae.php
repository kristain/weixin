	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
				  <th><span class="red"></span>金额变动短信通知：</th> 
				  <td>开启&nbsp;
					<input type="radio" class="px" id="money_chg_send_sms" value="1" name="money_chg_send_sms" <?php if(($set["money_chg_send_sms"]) == "1"): ?>checked<?php endif; ?> />
	                关闭&nbsp;
					<input type="radio" class="px" id="money_chg_send_sms" value="0" name="money_chg_send_sms" <?php if(($set["money_chg_send_sms"]) == "0"): ?>checked<?php endif; ?> />
				</tr>
				<tr>      
				  <th><span class="red"></span>积分变动短信通知：</th> 
                <td>开启&nbsp;
					<input type="radio" class="px" id="integral_chg_send_sms" value="1" name="integral_chg_send_sms" <?php if(($set["integral_chg_send_sms"]) == "1"): ?>checked<?php endif; ?> />
	                关闭&nbsp;
                    <input type="radio" class="px" id="integral_chg_send_sms" value="0" name="integral_chg_send_sms" <?php if(($set["integral_chg_send_sms"]) == "0"): ?>checked<?php endif; ?> />
				</tr>
				<tr>
