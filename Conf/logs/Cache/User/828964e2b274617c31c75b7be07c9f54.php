...
<div class="content"  >
   ...
   <div class="cLineB"> 
    ...
    <a href="<?php echo U('Fenlei/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a> 
...
<?php if($isUpdate == 1): ?><input type="hidden" name="id" value="<?php echo ($set["id"]); ?>" /><?php endif; ?>
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tbody> 
	   ...
	   <tr> 
        ...
        <td><input  type="text" id="name" name="title" value="<?php echo ($set["title"]); ?>" class="px" style="width:400px;" /></td> 
	   ...
	   <tr> 
        ...
        <td><input type="text" name="topic" value="<?php echo ($set["topic"]); ?>" id="small_pic" class="px" style="width:400px;"  readonly="readonly"/><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('small_pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('small_pic')">预览</a>   &nbsp; 大小为720x400</td>
        ...
        <TR>
            ...
            <TD><textarea name="info" class="px" id="content"  rows="5" style="width:500px;height:150px"><?php echo ($set["info"]); ?></textarea></TD>
 ...
 <tr> 
       ...
       <button type="submit" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Fenlei/index',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
