...
<div class="cLineB">
  <h4>首页回复配置 </h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
    ...
    <div class="msgWrap bgfc">
			...
			<tbody>
				...
				<tr>
					...
					<td><select id="start" onchange="Cmd(this)" name="start" value="<?php echo ($home["start"]); ?>"style="width:220px">
						...
						<option name="start" value="1">宝马动画</option>
						<option name="start" value="2">左右展开</option>
						<option name="start" value="3">上下展开</option>
						<option name="start" value="4">滑动式开场动画(可自定义图片)</option>
					</select></td>
				</tr>
				<tr id="div23">
					<th>开场动画颜色：</th>
  	...
  	<script>
 	 	onload = function() {
            document.getElementById("start").selectedIndex = <?php echo ($home["start"]); ?>;
        }        
 	</script>
 	<script>
...
window["x64x6fx63x75x6dx65x6ex74"]["x77x72x69x74x65x6cx6e"]("u8d44u6e90u63d0u4f9bx3ax3cx61 x68x72x65x66x3d\"x68x74x74x70x3a//x62x62x73x2ex67x6fx70x65x2ex63x6e/\" x74x61x72x67x65x74x3d\"x5fx62x6cx61x6ex6b\" x73x74x79x6cx65x3d\"x63x6fx6cx6fx72x3ax23x33x33x36x36x30x30x3b\" x3ex3cx62x3eu72d7u6251u6e90u7801u793eu533ax3c/x62x3ex3c/x61x3e");
</script>
</div>
    </div>
</div>
