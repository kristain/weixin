		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
             ...
             <tr>
				  ...
				  <td><input type="text" name="keyword" value="<?php echo ($info["keyword"]); ?>" class="px" style="width:550px;"></td>
			</tr>
...
<a href="###" onclick="viewImg('picurl1')" >预览</a>
				 ...
				 <tr>
				  <th valign="top"><span class="red">*</span>底部广告：</th>
				  <td><input type="text" name="ad"  id="ad" value="<?php echo ($info["ad"]); ?>" class="px" style="width:550px;">
				  <script src="/tpl/static/upyun.js"></script>
<a href="javascript:void(0)" onclick="upyunPicUpload('ad',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a>
<a href="###" onclick="viewImg('ad')" >预览</a>
<br />大小为580x90像素
					</td>
				</tr>
				<tr>
				  <th valign="top"><span class="red">*</span>广告链接：</th>
				  <td><input type="text" name="lj" value="<?php echo ($info["lj"]); ?>" class="px" style="width:550px;">
					</td>
				</tr>
				<tr>
				  <th valign="top"><span class="red">*</span>分享后跳转链接：</th>
				  <td><input type="text" name="yd" value="<?php echo ($info["yd"]); ?>" class="px" style="width:550px;">
					</td>
				</tr>
